...
if __name__=='__main__':
   # config={'emb_dim':6,'n_heads':3}
   # mha=MultiheadMaskedSelfAttention(config)
   # print('model state dict has :',mha.state_dict())
   # print('model parametershas :',)
   # for i in mha.parameters():
   #    print(i)
   # x=torch.randn(2,3,6)
   # print(f'Input is of shape {x.shape} \n : {x}')
   # output=mha(x)
   # print(f'output is : {output} :',output.shape)
